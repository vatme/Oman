...
Sector file for Oman at VATME. Compatible with the Euroscope radar client only. Not tested with VRC so it may or may not work with VRC.
...
5. Browse to the folder where you extracted the zip file in step 3 and choose the OOMM.prf file
...
3. Open the extracted files and copy the DataFiles folder and OOMM.ese file. Go to your current sector file folder for OOMM and replace the DataFiles and .ese file with the ones you just copied. 
